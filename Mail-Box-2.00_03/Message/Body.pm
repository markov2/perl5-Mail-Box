...
Read the body from the FILE. The implementation of this method will differ
from body type to body type.  Read the associated documentation for the
details.

The LENGTH argument is the estimated number of bytes in the body, or
...
This code is beta version 2.00_03, and far from complete.  Please

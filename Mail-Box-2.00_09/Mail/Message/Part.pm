...
The general methods for C<Mail::Message::Part> objects:
   ...
   MM attach MESSAGES [,OPTIONS]        MM modified [BOOL]
   MM decoded OPTIONS                      new OPTIONS
   MM encode TYPE                       MM nrLines
   MR errors                            MM parent
   MM get FIELD                         MM print [FILEHANDLE]
...
The extra methods for extension writers:
   ...
   MM coerce MESSAGE [,OPTIONS]         MR notImplemented
   MM head [OBJECT]                     MM read PARSER, HEADTYPE, BODY...

...
The general methods for C<Mail::Box::Parser> objects:
      ...
      defaultParser [PARSER]               readHeader
   MR errors                               readSeparator OPTIONS
      foldHeaderLine LINE, LENGTH       MR report [LEVEL]
      inDosmode                         MR reportAll [LEVEL]
   MR log [LEVEL [,STRINGS]]               setPosition WHERE
      new [OPTIONS]                        start OPTIONS
   MR new OPTIONS                          stop

...
The general methods for C<Mail::Message::Head::Subset> objects:
  ...
  MMH add NAME, BODY [,COMMENT]         MR log [LEVEL [,STRINGS]]
  ...
  MMH createMessageId                 MMHC new OPTIONS
   MR errors                            MR new OPTIONS
      get NAME [,INDEX]                MMH print FILE [,LINE-LENGTH]
  MMH get NAME [,INDEX]                 MR report [LEVEL]
  MMH grepNames [NAMES|ARRAY-OF-N...    MR reportAll [LEVEL]
  MMH guessBodySize                    MMH reset NAME, FIELDS
  MMH guessTimestamp                   MMH set NAME, BODY [,COMMENT]
  MMH isDelayed                        MMH timestamp
  MMH isMultipart                       MR trace [LEVEL]

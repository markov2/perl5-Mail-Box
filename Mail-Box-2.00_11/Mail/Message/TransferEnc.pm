...
The extra methods for extension writers:
   ...
   MR DESTROY                           MR logPriority LEVEL
      addTransferEnc TYPE, CLASS              MR logSettings
...
Use the encoder to decode the content of BODY into a new RESULT-BODY object.
...
Use the encoder to encode the content of BODY into a new RESULT-BODY object.
Both are instances of C<Mail::Message::Body> objects.  The latter object
is returned.

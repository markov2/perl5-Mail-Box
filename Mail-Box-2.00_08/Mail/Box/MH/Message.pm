...
The general methods for C<Mail::Box::MH::Message> objects:
  ...
  MBM deleted [BOOL]                    MM parent
   MR errors                               print TO
      filename [FILENAME]                  printIndex [FILEHANDLE]
  MBM folder [FOLDER]                      readIndex CLASS [,FILEHANDLE]
  ...
  MBM labels                            MM toplevel
      load CLASS [, ARRAY-OF-LINES]     MR trace [LEVEL]

The extra methods for extension writers:

  MBM coerce FOLDER, MESSAGE [,OP...    MR logSettings
  MBM diskDelete                        MR notImplemented
   MR logPriority LEVEL                MBM read PARSER, HEADTYPE, BODY...

...
The general methods for C<Mail::Message::Head> objects:
      ...
      add ...                              nrLines
      clone [FIELDS]                       print FILE [,LINE-LENGTH]
      count NAME                        MR report [LEVEL]
   MR errors                            MR reportAll [LEVEL]
      get NAME [,INDEX]                    reset NAME, FIELDS
      isDelayed                            set ...
      isMultipart                          size
...
The extra methods for extension writers:
      ...
      createFromLine                    MR logPriority LEVEL
      createMessageId                   MR logSettings
      grepNames [NAMES|ARRAY-OF-N...       message [MESSAGE]
      guessBodySize                     MR notImplemented
      guessTimestamp                       read PARSER
      load                                 wrapLength [CHARS]

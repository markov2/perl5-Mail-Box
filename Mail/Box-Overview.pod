...
Mail::Message::Body::Construct and Mail::Message::Body::Encode.  The former
package implements things like concatenation, the later controls message
...
Mail::Box-Cookbook, and the web-site L<http://perl.overmeer.net/mailbox>.

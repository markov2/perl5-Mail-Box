...
See M<Mail::Message::Field::Fast::new()>, M<Mail::Message::Field::Flex::new()>,
...
M<unfoldedBody()> is being stripped and returned.
...
This method is called by M<new()>, and usually not be an application
program.

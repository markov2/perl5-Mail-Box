...
use base qw/Mail::Box Mail::Box::Index/;
...
Be warned, that if the message is not read at all, each message of the
folder will be parsed, at least to get its header.  The headers are
read from back to front in the folder.

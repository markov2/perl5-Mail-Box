...
The extra methods for extension writers:
      ...
      lazyExtract HEADER, BODY, SIZE       readBodyType HEAD, SIZE, LAZY
...
{   my ($self, $message) = @_;
    ...
    {   # The message is  native to Mail::Box.   Be sure that the message
        # is loaded, before it is converted to a new type.
        $message->forceLoad if $message->can('forceLoad');
    }

    elsif($message->isa('MIME::Entity'))

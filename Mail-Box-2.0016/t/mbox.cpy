...
Received: from ns.ATComputing.nl (ns.ATComputing.nl [195.108.229.25])
        ...
        for <markov@ATComputing.nl>;
        Sun, 2 Jul 2000 02:40:25 +0200 (MET DST)
Received: (from nobody@localhost) by ns.ATComputing.nl (8.8.8/8.8.8) id
        CAA03454 for <markov@ATComputing.nl>;
        Sun, 2 Jul 2000 02:40:24 +0200
Received: from mustang.oldcity.dca.net(216.158.38.3) by
        ns.ATComputing.nl via smap (V2.1) id xma003450;
        Sun, 2 Jul 00 02:40:07 +0200
Received: from unca-don.wizards.dupont.com ([204.183.81.133]) by
        mustang.oldcity.dca.net (8.9.3/8.9.3/DCANET) with ESMTP id
        UAA32165; Sat, 1 Jul 2000 20:39:55 -0400
Received: (from majordomo@localhost) by unca-don.wizards.dupont.com
        (8.9.3/8.9.3) id UAA16952 for magick-outgoing;
        Sat, 1 Jul 2000 20:30:03 -0400 (EDT)
X-Authentication-Warning: unca-don.wizards.dupont.com: majordomo set sender to owner-magick@wizards.dupont.com using -f
...
Received: from ns.ATComputing.nl (ns.ATComputing.nl [195.108.229.25])
        ...
        for <markov@ATComputing.nl>;
        Mon, 3 Jul 2000 16:12:41 +0200 (MET DST)
Received: (from nobody@localhost) by ns.ATComputing.nl (8.8.8/8.8.8) id
        QAA05092 for <markov@ATComputing.nl>;
        Mon, 3 Jul 2000 16:12:40 +0200
Received: from mustang.oldcity.dca.net(216.158.38.3) by
        ns.ATComputing.nl via smap (V2.1) id xma005088;
        Mon, 3 Jul 00 16:12:32 +0200
Received: from unca-don.wizards.dupont.com ([204.183.81.133]) by
        mustang.oldcity.dca.net (8.9.3/8.9.3/DCANET) with ESMTP id
        KAA12560; Mon, 3 Jul 2000 10:12:03 -0400
Received: (from majordomo@localhost) by unca-don.wizards.dupont.com
        (8.9.3/8.9.3) id KAA20768 for magick-outgoing;
        Mon, 3 Jul 2000 10:01:07 -0400 (EDT)
X-Authentication-Warning: unca-don.wizards.dupont.com: majordomo set sender to owner-magick@wizards.dupont.com using -f
...
Received: from ns.ATComputing.nl (ns.ATComputing.nl [195.108.229.25])
        ...
        for <markov@ATComputing.nl>;
        Fri, 7 Jul 2000 09:27:32 +0200 (MET DST)
Received: (from nobody@localhost) by ns.ATComputing.nl (8.8.8/8.8.8) id
        JAA11016 for <markov@ATComputing.nl>;
        Fri, 7 Jul 2000 09:27:31 +0200
Received: from viper.oldcity.dca.net(216.158.38.4) by ns.ATComputing.nl
        via smap (V2.1) id xma011014; Fri, 7 Jul 00 09:27:21 +0200
Received: from unca-don.wizards.dupont.com ([204.183.81.133]) by
        viper.oldcity.dca.net (8.9.3/8.9.3/DCANET) with ESMTP id
        DAA06530; Fri, 7 Jul 2000 03:26:27 -0400
Received: (from majordomo@localhost) by unca-don.wizards.dupont.com
        (8.9.3/8.9.3) id DAA06369 for magick-outgoing;
        Fri, 7 Jul 2000 03:15:15 -0400 (EDT)
X-Authentication-Warning: unca-don.wizards.dupont.com: majordomo set sender to owner-magick@wizards.dupont.com using -f
...
In-Reply-To: <00070515380200.26142@berlioz>;
        from geofstro@monaco.mc on Wed, Jul 05, 2000 at 03:35:26PM +0200
...
Received: from ns.ATComputing.nl (ns.ATComputing.nl [195.108.229.25])
        ...
        for <markov@ATComputing.nl>;
        Fri, 7 Jul 2000 17:55:42 +0200 (MET DST)
Received: (from nobody@localhost) by ns.ATComputing.nl (8.8.8/8.8.8) id
        RAA15121 for <markov@ATComputing.nl>;
        Fri, 7 Jul 2000 17:55:42 +0200
Received: from mustang.oldcity.dca.net(216.158.38.3) by
        ns.ATComputing.nl via smap (V2.1) id xma015105;
        Fri, 7 Jul 00 17:55:27 +0200
Received: from unca-don.wizards.dupont.com ([204.183.81.133]) by
        mustang.oldcity.dca.net (8.9.3/8.9.3/DCANET) with ESMTP id
        LAA24776; Fri, 7 Jul 2000 11:54:30 -0400
Received: (from majordomo@localhost) by unca-don.wizards.dupont.com
        (8.9.3/8.9.3) id LAA07897 for magick-outgoing;
        Fri, 7 Jul 2000 11:44:52 -0400 (EDT)
X-Authentication-Warning: unca-don.wizards.dupont.com: majordomo set sender to owner-magick@wizards.dupont.com using -f
...
Content-Type: text/plain; charset=us-ascii
X-Mailer: Mutt 1.0pre4i
In-Reply-To: <200007080855.EAA15589@imagemagick.org>;
        from Majordomo@imagemagick.org on Sat, Jul 08,
        2000 at 04:55:40AM -0400
Status: RO
Content-Length: 63
Lines: 1
...
Received: from ns.ATComputing.nl (ns.ATComputing.nl [195.108.229.25])
        ...
        for <markov@ATComputing.nl>;
        Sat, 8 Jul 2000 10:27:39 +0200 (MET DST)
Received: (from nobody@localhost) by ns.ATComputing.nl (8.8.8/8.8.8) id
        KAA25253 for <markov@ATComputing.nl>;
        Sat, 8 Jul 2000 10:27:38 +0200
Received: from magick.imagemagick.org(38.220.172.2) by
        ns.ATComputing.nl via smap (V2.1) id xma025238;
        Sat, 8 Jul 00 10:27:26 +0200
Received: (from majordomo@localhost) by imagemagick.org (8.9.3/8.9.3)
        id EAA15589; Sat, 8 Jul 2000 04:55:40 -0400
...
Received: from ns.ATComputing.nl (ns.ATComputing.nl [195.108.229.25])
        ...
        for <markov@ATComputing.nl>;
        Sat, 8 Jul 2000 13:53:33 +0200 (MET DST)
Received: (from nobody@localhost) by ns.ATComputing.nl (8.8.8/8.8.8) id
        NAA00576 for <markov@ATComputing.nl>;
        Sat, 8 Jul 2000 13:53:28 +0200
Received: from magick.imagemagick.org(38.220.172.2) by
        ns.ATComputing.nl via smap (V2.1) id xma000568;
        Sat, 8 Jul 00 13:53:23 +0200
Received: (from majordomo@localhost) by imagemagick.org (8.9.3/8.9.3)
        id IAA16219; Sat, 8 Jul 2000 08:21:42 -0400
...
Content-Type: text/plain; charset=us-ascii
X-Mailer: Mutt 1.0pre4i
In-Reply-To: <397C6C6B.989E4BB2@catchword.com>;
        from chris.wareham@catchword.com on Mon, Jul 24,
        2000 at 05:18:51PM +0100
Status: RO
Content-Length: 2223
Lines: 55
...
Received: from ns.ATComputing.nl (ns.ATComputing.nl [195.108.229.25])
        ...
        for <markov@ATComputing.nl>;
        Mon, 24 Jul 2000 18:24:10 +0200 (MET DST)
Received: (from nobody@localhost) by ns.ATComputing.nl (8.8.8/8.8.8) id
        SAA20827 for <markov@ATComputing.nl>;
        Mon, 24 Jul 2000 18:24:09 +0200
Received: from viper.oldcity.dca.net(216.158.38.4) by ns.ATComputing.nl
        via smap (V2.1) id xma020823; Mon, 24 Jul 00 18:23:51 +0200
Received: from unca-don.wizards.dupont.com ([204.183.81.133]) by
        viper.oldcity.dca.net (8.9.3/8.9.3/DCANET) with ESMTP id
        MAA20883; Mon, 24 Jul 2000 12:23:50 -0400
Received: (from majordomo@localhost) by unca-don.wizards.dupont.com
        (8.9.3/8.9.3) id MAA01738 for magick-outgoing;
        Mon, 24 Jul 2000 12:07:32 -0400 (EDT)
X-Authentication-Warning: unca-don.wizards.dupont.com: majordomo set sender to owner-magick@wizards.dupont.com using -f
...
Content-Type: text/plain; charset=us-ascii
X-Mailer: Mutt 1.0pre4i
In-Reply-To: <397ECFEF.598EE285@catchword.com>;
        from chris.wareham@catchword.com on Wed, Jul 26,
        2000 at 12:47:59PM +0100
Status: RO
Content-Length: 754
Lines: 16
...
Received: from ns.ATComputing.nl (ns.ATComputing.nl [195.108.229.25])
        ...
        for <markov@ATComputing.nl>;
        Wed, 26 Jul 2000 13:46:33 +0200 (MET DST)
Received: (from nobody@localhost) by ns.ATComputing.nl (8.8.8/8.8.8) id
        NAA24001 for <markov@ATComputing.nl>;
        Wed, 26 Jul 2000 13:46:32 +0200
Received: from figaro.catchword.co.uk(194.129.29.1) by
        ns.ATComputing.nl via smap (V2.1) id xma023999;
        Wed, 26 Jul 00 13:46:13 +0200
Received: from catchword.com (valkyrie.catchword.co.uk
        [194.129.29.105]) by figaro.catchword.co.uk (8.9.2/8.9.2) with
        ESMTP id LAA10217 for <markov@ATComputing.nl>;
        Wed, 26 Jul 2000 11:49:37 GMT
...
Content-Type: text/plain; charset=us-ascii
X-Mailer: Mutt 1.0pre4i
In-Reply-To: <4.3.1.0.20000801154753.00ae3ed0@mindspring.com>;
        from blburch@mindspring.com on Tue, Aug 01,
        2000 at 03:54:42PM -0400
Status: RO
Content-Length: 1041
Lines: 24
...
Received: from ns.ATComputing.nl (ns.ATComputing.nl [195.108.229.25])
        ...
        for <markov@ATComputing.nl>;
        Tue, 1 Aug 2000 22:37:13 +0200 (MET DST)
Received: (from nobody@localhost) by ns.ATComputing.nl (8.8.8/8.8.8) id
        WAA04892 for <markov@ATComputing.nl>;
        Tue, 1 Aug 2000 22:37:12 +0200
Received: from viper.oldcity.dca.net(216.158.38.4) by ns.ATComputing.nl
        via smap (V2.1) id xma004890; Tue, 1 Aug 00 22:37:04 +0200
Received: from unca-don.wizards.dupont.com ([204.183.81.133]) by
        viper.oldcity.dca.net (8.9.3/8.9.3/DCANET) with ESMTP id
        QAA28454; Tue, 1 Aug 2000 16:36:07 -0400
Received: (from majordomo@localhost) by unca-don.wizards.dupont.com
        (8.9.3/8.9.3) id PAA24962 for magick-outgoing;
        Tue, 1 Aug 2000 15:46:55 -0400 (EDT)
X-Authentication-Warning: unca-don.wizards.dupont.com: majordomo set sender to owner-magick@wizards.dupont.com using -f
...
Received: from ns.ATComputing.nl (ns.ATComputing.nl [195.108.229.25])
        ...
        for <markov@ATComputing.nl>;
        Wed, 4 Oct 2000 19:56:00 +0200 (MET DST)
Received: from imagemagick.org (magick.imagemagick.org [38.220.172.2])
        by ns.ATComputing.nl (Postfix) with ESMTP id 84B2DED32 for
        <markov@ATComputing.nl>; Wed, 4 Oct 2000 19:55:58 +0200 (CEST)
Received: (from majordomo@localhost) by imagemagick.org
        (8.11.0.Beta3/8.9.3) id e94IMj420302 for
        magick-developer-outgoing; Wed, 4 Oct 2000 14:22:45 -0400
X-Authentication-Warning: magick.imagemagick.org: majordomo set sender to owner-magick@imagemagick.org using -f

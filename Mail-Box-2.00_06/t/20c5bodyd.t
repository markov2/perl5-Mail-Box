...
my $body = Mail::Message::Body::Delayed->new;
...
{   my (undef, $sep) = $parser->readSeparator;
    ...
    $body = Mail::Message::Body::Delayed->new->read($parser, $cl, $li);
    $ok++ if $body;
...
{   my (undef, $sep) = $parser->readSeparator;
    ...
    $body = Mail::Message::Body::Delayed->new->read($parser);
    $ok++ if $body;
...
{   my $ok  = 0;
    ...
    $body = Mail::Message::Body::Delayed->new;

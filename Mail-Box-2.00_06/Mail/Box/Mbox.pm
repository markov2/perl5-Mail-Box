...
The general methods for C<Mail::Box::Mbox> objects:
   ...
   MB clone OPTIONS                     MB name
   MB close OPTIONS                        new ARGS
   MB coerce MESSAGE                       openSubFolder NAME [,OPTIONS]
      create FOLDERNAME [, OPTIONS]     MB organization
   ...
   MB lazyExtract HEADER, BODY, SIZE    MR warnings
      listFolders [OPTIONS]                write

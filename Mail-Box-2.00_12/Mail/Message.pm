...
The general methods for C<Mail::Message> objects:
  ...
  MMC build OPTIONS                        nrLines
  MMC buildFromBody BODY                   parent
...
The extra methods for extension writers:
   ...
   MR AUTOLOAD                          MR logPriority LEVEL
      ...
      coerce MESSAGE [,OPTIONS]            readBody PARSER, HEAD [, BO...
...
dedicated manual page C<Mail::Message::Encode>.  The OPTIONS which
...
{   my $self = shift;
    ...
    my $body 
      = $rawbody->isBinary
      ? $rawbody->encode(transferEncoding => 'base64')
      : $rawbody->encode;    # check encoding when still needed
